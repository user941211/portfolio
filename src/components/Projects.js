  ...
  return (
    <article className="bg-blue-950">
      <div className="max-w-6xl w-full mx-auto py-8 px-16">
        <div>
          <div className="projects_title underline text-underline-color-white decoration-gray-950 underline-offset-8 decoration-1 mt-9 font-bold text-5xl p-3">Projects</div>
        </div>
          ...
          <div>
            ...
            <table className="mx-auto">
              <tbody>
                <tr>
                  <td className="font-bold p-3">주요기능</td>
                  <td className=" p-3">회원가입, 로그인, 주문하기, 장바구니 등 CRUD 및 파생 기능 등</td>
                </tr>
                <tr>
        ...
        <div className="rounded-lg border p-5 m-5 bg-white">
          <div>
            ...
            <div className="mb-8 font-normal text-base text-gray-600 text-center opacity-80">2023.08 - 08(1인 프로젝트)</div>
            <div className="w-8/12 mx-auto my-5">다시 Server-Side-Rendering이 대세가 되고 있는 요즘, React로 할 수 있는 SSR인 NextJS을 이용한 간단한 프로젝트입니다. mongodb를 이용해 자료를 저장하며, jwt를 이용해 로그인 및 회원가입을 진행하였습니다.</div>
            <table className="mx-auto">
              <tbody>
                <tr>
                  <td className="font-bold p-3">주요기능</td>
                  <td className=" p-3">회원가입, 로그인 및 blog에 기초적으로 들어가는 CRUD 제작</td>
                </tr>
                <tr>
                  <td className="font-bold p-3" rowSpan="2" >Github</td>
                  <td className="underline decoration-sky-500 p-3"><Link to="https://github.com/user941211/blog">NextJS13을 이용한 CRUD blog(코드)</Link></td>
                </tr>
                <tr>
                  <td className="underline decoration-sky-500 p-3"><Link to="https://blog-iwmkp0qop-user941211.vercel.app/">NEXTJS blog(현재 배포중인 사이트)</Link></td>
                </tr>
                <tr>
                  <td className="font-bold p-3">Frontend</td>
                  <td className=" p-3">React, JavaScript, tailwindCSS</td>
                </tr>
                <tr>
                  <td className="font-bold p-3">Backend</td>
                  <td className=" p-3">NoSQL, MongoDB, NEXTJS, NEXT-AUTH.js</td>
                </tr>
                <tr>
                  <td className="font-bold p-3">Deployment</td>
